...
from proveedores.proveedoresGUI  import ProveedoresGUI   # 👈 AÑADIDO
...
def abrir_menu_principal(rol_usuario):
    ...
    # 👉 **Nuevo botón de proveedores**
    btn_proveedores = boton("Proveedores", lambda: ProveedoresGUI(menu))
    btn_proveedores.pack(pady=6)
