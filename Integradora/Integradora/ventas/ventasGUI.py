...
class VentasGUI(tk.Toplevel):
    def __init__(self, parent):
        ...
        tk.Label(frame, text="ID Producto:",
                 bg=self.color_fondo, fg=self.color_texto).grid(row=0, column=0, padx=5, pady=5)
        self.entry_producto = tk.Entry(frame, width=25)
        self.entry_producto.grid(row=0, column=1)

        tk.Label(frame, text="Cantidad:",
                 bg=self.color_fondo, fg=self.color_texto).grid(row=1, column=0, padx=5, pady=5)
        self.entry_cantidad = tk.Entry(frame, width=25)
        self.entry_cantidad.grid(row=1, column=1)

        # --- BOTONES ---
        frame_btn = tk.Frame(self, bg=self.color_fondo)
    ...
    def registrar_venta(self):
        ...
        # 🔥 CORREGIDO: el campo es id_producto, no id
    ...
    def mostrar_ventas(self):
        ...
        # 🔥 CORREGIDO: el campo es id_venta, no id
        cursor.execute("""
    ...
    def eliminar_venta(self):
        ...
        # 🔥 CORREGIDO: el campo es id_venta
